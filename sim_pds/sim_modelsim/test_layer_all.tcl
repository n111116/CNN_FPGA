...
vlog -work rtl_work -sv \
     +incdir+$INC_PATH \
     +define+DATA_PATH="$MEM_DATA_PATH" \
     [file join $ROOT_DIR sim_pds tb_layer.sv]
...
vsim -t 1ns -L rtl_work -L work +SEED=$rnd_seed -gTARGET_LAYER=$TARGET_LAYER -voptargs="+acc" tb_layer
