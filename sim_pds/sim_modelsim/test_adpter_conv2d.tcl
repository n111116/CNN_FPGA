...
vlog -work rtl_work -sv \
     +incdir+$INC_PATH \
     +define+DATA_PATH="$MEM_DATA_PATH" \
     ../tb_usb_to_pe_adapter_conv2d.sv
...
vsim -t 1ns -L rtl_work -L work +SEED=$rnd_seed -voptargs="+acc" tb_usb_to_pe_adapter_conv2d

# 7. 运行
do wave_adpter_conv2d.do
run 35us