...
module tb_post_cv3_conv2d;
    ...
    logic output_valid;
    // 输入数据
    logic [PE_PAGE_NUM_LAYER11-1:0] [DATA_WIDTH_LAYER11-1:0] data_input ;
    logic [PE_COL_NUM_LAYER11-1:0] [OUT_WIDTH_LAYER11-1:0] y_out ;
    ...
    logic frame_done;
    // 仿真内存
    logic [0:MEM_DEPTH-1] [DATA_WIDTH_LAYER11-1:0] file_mem ;
