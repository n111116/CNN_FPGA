...
module PLL (
    ...
    localparam real    CLKIN_FREQ       = 74.25; //@IPC float 10.0,500.0 
    ...
    localparam real    STATIC_RATIO0    = 74.25; //@IPC int 1.0000,128.0000 
        
    localparam integer STATIC_RATIO1    = 2; //@IPC int 1,128 
    
    localparam integer STATIC_RATIO2    = 5; //@IPC int 1,128 
    ...
    localparam integer STATIC_DUTY0     = 74; //@IPC int 2,255
    
    localparam integer STATIC_DUTY1     = 2; //@IPC int 2,255
    
    localparam integer STATIC_DUTY2     = 5; //@IPC int 2,255
