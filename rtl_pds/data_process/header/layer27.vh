...
`define LAYER27_VH
    ...
    parameter int unsigned PE_ROW_NUM_LAYER27       = 9;  
    parameter int unsigned KERNEL_COL_LAYER27       = 3;
    parameter int unsigned KERNEL_ROW_LAYER27       = 3;  
    parameter int unsigned CHANNEL_OUT_NUM_LAYER27  = 64;
    parameter int unsigned CHANNEL_IN_NUM_LAYER27   = 32;  
    ...
    parameter int unsigned BIAS_WIDTH_LAYER27       = 19;
    parameter int unsigned OUT_WIDTH_LAYER27        = 9;

    // 3. 周期与映射参数
    parameter int unsigned CYCLE_PERIOD_IN_LAYER27  = 16; 
    parameter int unsigned CYCLE_PERIOD_OUT_LAYER27 = 32;
    parameter int unsigned CYCLE_PERIOD_LAYER27     = CYCLE_PERIOD_IN_LAYER27 * CYCLE_PERIOD_OUT_LAYER27;
    parameter int unsigned SHIFT_KEY_LAYER27        = 11;

    // 4. 图像尺寸
    parameter int unsigned IMG_COL_LAYER27          = 40;
    parameter int unsigned IMG_ROW_LAYER27          = 10;

    // 5. 自动计算的中间位宽
    parameter int unsigned PE_PAGE_OUTPUT_WIDTH_LAYER27 = 23;
    parameter int unsigned ACC_WIDTH_LAYER27        = 28;

    /* Simulation Paths */
    localparam INPUT_FILE_PATH_LAYER27       = "C:/Users/Datou21/Desktop/PDS/back1/cnn_usb_copy/conv_data_hex_pds/layer27_input_9bit.hex";
