...
`define LAYER25_VH
    ...
    // 1. 架构参数
    parameter int unsigned PE_PAGE_NUM_LAYER25      = 2;
    parameter int unsigned PE_COL_NUM_LAYER25       = 2;  
    ...
    parameter int unsigned CHANNEL_OUT_NUM_LAYER25  = 32;
    parameter int unsigned CHANNEL_IN_NUM_LAYER25   = 32;  
    ...
    parameter int unsigned STEP_COL_LAYER25         = 2;
    ...
    // 3. 周期与映射参数
    parameter int unsigned CYCLE_PERIOD_IN_LAYER25  = 16; 
    parameter int unsigned CYCLE_PERIOD_OUT_LAYER25 = 16;
    ...
    // 4. 图像尺寸
    parameter int unsigned IMG_COL_LAYER25          = 80;
    parameter int unsigned IMG_ROW_LAYER25          = 20;

    // 5. 自动计算的中间位宽
    parameter int unsigned PE_PAGE_OUTPUT_WIDTH_LAYER25 = 14;
    parameter int unsigned ACC_WIDTH_LAYER25        = 19;

    /* Simulation Paths */
    localparam INPUT_FILE_PATH_LAYER25       = "C:/Users/Datou21/Desktop/PDS/back1/cnn_usb_copy/conv_data_hex_pds/layer25_input_9bit.hex";
