...
`define LAYER24_VH
    ...
    // 1. 架构参数
    parameter int unsigned PE_PAGE_NUM_LAYER24      = 2;
    parameter int unsigned PE_COL_NUM_LAYER24       = 2;  
    ...
    parameter int unsigned CHANNEL_OUT_NUM_LAYER24  = 32;
    parameter int unsigned CHANNEL_IN_NUM_LAYER24   = 16;  
    ...
    parameter int unsigned STEP_COL_LAYER24         = 1;
    parameter USE_DSP_PE_LAYER24                    = "no";
  
    // 2. 位宽参数 (来自 MAT)  
    parameter int unsigned DATA_WIDTH_LAYER24       = 9;
    parameter int unsigned WEIGHT_WIDTH_LAYER24     = 10;
    parameter int unsigned BIAS_WIDTH_LAYER24       = 19;
    parameter int unsigned OUT_WIDTH_LAYER24        = 9;

    // 3. 周期与映射参数
    parameter int unsigned CYCLE_PERIOD_IN_LAYER24  = 8; 
    parameter int unsigned CYCLE_PERIOD_OUT_LAYER24 = 16;
    ...
    // 4. 图像尺寸
    parameter int unsigned IMG_COL_LAYER24          = 80;
    parameter int unsigned IMG_ROW_LAYER24          = 20;

    // 5. 自动计算的中间位宽
    parameter int unsigned PE_PAGE_OUTPUT_WIDTH_LAYER24 = 23;
    parameter int unsigned ACC_WIDTH_LAYER24        = 27;

    /* Simulation Paths */
    localparam INPUT_FILE_PATH_LAYER24       = "C:/Users/Datou21/Desktop/PDS/back1/cnn_usb_copy/conv_data_hex_pds/layer24_input_9bit.hex";
