...
`define LAYER26_VH
    ...
    // 1. 架构参数
    parameter int unsigned PE_PAGE_NUM_LAYER26      = 2;
    parameter int unsigned PE_COL_NUM_LAYER26       = 2;  
    ...
    parameter int unsigned CHANNEL_OUT_NUM_LAYER26  = 32;
    parameter int unsigned CHANNEL_IN_NUM_LAYER26   = 32;  
    ...
    parameter int unsigned BIAS_WIDTH_LAYER26       = 20;
    parameter int unsigned OUT_WIDTH_LAYER26        = 9;

    // 3. 周期与映射参数
    parameter int unsigned CYCLE_PERIOD_IN_LAYER26  = 16; 
    parameter int unsigned CYCLE_PERIOD_OUT_LAYER26 = 16;
    parameter int unsigned CYCLE_PERIOD_LAYER26     = CYCLE_PERIOD_IN_LAYER26 * CYCLE_PERIOD_OUT_LAYER26;
    parameter int unsigned SHIFT_KEY_LAYER26        = 11;

    // 4. 图像尺寸
    parameter int unsigned IMG_COL_LAYER26          = 40;
    parameter int unsigned IMG_ROW_LAYER26          = 10;

    // 5. 自动计算的中间位宽
    parameter int unsigned PE_PAGE_OUTPUT_WIDTH_LAYER26 = 23;
    parameter int unsigned ACC_WIDTH_LAYER26        = 28;
