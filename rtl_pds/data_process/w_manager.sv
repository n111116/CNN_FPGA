...
module w_manager #(
    ...
    parameter WEIGHT_FILE = "weights_layer1_page0.mem"
)(
    input  logic clk,
    input  logic clk_en,
    input  logic new_line_1,
    // 输出: [列][行]
    output logic signed [PE_COL_NUM-1:0][PE_ROW_NUM-1:0] [WEIGHT_WIDTH-1:0] W_out
);
    ...
    // 3. 并行读取逻辑
    logic  [PE_COL_NUM-1:0] [COL_WEIGHT_WIDTH-1:0] raw_data_per_col_reg;
