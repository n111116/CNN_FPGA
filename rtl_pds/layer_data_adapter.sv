...
module layer_data_adapter #(
    ...
    // PE 接口 (给 PE 的输入)
    output logic  [23:0]    pe_parallel_data, 
        ...
        if (!rst_n) begin
            ...
            if (data_latch_valid) begin
                ...
                //  if (usb_fifo_data[31:24] == 8'h00)
                    ...
                    pe_parallel_data[ 7: 0] <= usb_fifo_data[ 7: 0];
                    pe_parallel_data[15: 8] <= usb_fifo_data[15: 8];
                    pe_parallel_data[23:16] <= usb_fifo_data[23:16];
                    // for(ch = 0; ch < CHANNEL_IN; ch++) begin
