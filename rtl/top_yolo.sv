...
module top_yolo #(
    ...
    input  logic [DATA_WIDTH_LAYER0-1:0]        data_input [PE_PAGE_NUM_LAYER0-1:0],

    // ---------------- 输出接口 1 (Layer 8 原始特征图) ----------------
    output logic [OUT_WIDTH_LAYER8-1:0]         layer_y_out_layer8 [PE_COL_NUM_LAYER8-1:0],
...
// =========================================================
    // Layer 0 -> Layer 1
    (* mark_debug = "true"*) logic [OUT_WIDTH_LAYER0-1:0] layer_y_out_layer0 [PE_COL_NUM_LAYER0-1:0];
    (* mark_debug = "true"*) logic out_valid_layer0;
    (* mark_debug = "true"*) logic new_line_out_1_layer0;

    // Layer 1 -> Layer 2
    (* mark_debug = "true"*) logic [OUT_WIDTH_LAYER1-1:0] layer_y_out_layer1 [PE_COL_NUM_LAYER1-1:0];
    (* mark_debug = "true"*) logic out_valid_layer1;
    (* mark_debug = "true"*) logic new_line_out_1_layer1;

    // Layer 2 -> Layer 3
    (* mark_debug = "true"*) logic [OUT_WIDTH_LAYER2-1:0] layer_y_out_layer2 [PE_COL_NUM_LAYER2-1:0];
    (* mark_debug = "true"*) logic out_valid_layer2;
    (* mark_debug = "true"*) logic new_line_out_1_layer2;

    // Layer 3 -> Layer 4
    (* mark_debug = "true"*) logic [OUT_WIDTH_LAYER3-1:0] layer_y_out_layer3 [PE_COL_NUM_LAYER3-1:0];
    (* mark_debug = "true"*) logic out_valid_layer3;
    (* mark_debug = "true"*) logic new_line_out_1_layer3;

    // Layer 4 -> Layer 5
    (* mark_debug = "true"*) logic [OUT_WIDTH_LAYER4-1:0] layer_y_out_layer4 [PE_COL_NUM_LAYER4-1:0];
    (* mark_debug = "true"*) logic out_valid_layer4;
    (* mark_debug = "true"*) logic new_line_out_1_layer4;

    // Layer 5 -> Layer 6 & Layer 9
    (* mark_debug = "true"*) logic [OUT_WIDTH_LAYER5-1:0] layer_y_out_layer5 [PE_COL_NUM_LAYER5-1:0];
    (* mark_debug = "true"*) logic out_valid_layer5;
    (* mark_debug = "true"*) logic new_line_out_1_layer5;

    // Layer 6 -> Layer 7
    (* mark_debug = "true"*) logic [OUT_WIDTH_LAYER6-1:0] layer_y_out_layer6 [PE_COL_NUM_LAYER6-1:0];
    (* mark_debug = "true"*) logic out_valid_layer6;
    (* mark_debug = "true"*) logic new_line_out_1_layer6;

    // Layer 7 -> Layer 8
    (* mark_debug = "true"*) logic [OUT_WIDTH_LAYER7-1:0] layer_y_out_layer7 [PE_COL_NUM_LAYER7-1:0];
    (* mark_debug = "true"*) logic out_valid_layer7;
    (* mark_debug = "true"*) logic new_line_out_1_layer7;

    // // Layer 8 -> cv3 post_conv_2d 已在输出端口中定义
    // logic [OUT_WIDTH_LAYER8-1:0] layer_y_out_layer8 [PE_COL_NUM_LAYER8-1:0];
    // logic out_valid_layer8;
    // logic new_line_out_1_layer8;

    // Layer 9 -> Layer 10
    (* mark_debug = "true"*) logic [OUT_WIDTH_LAYER9-1:0] layer_y_out_layer9 [PE_COL_NUM_LAYER9-1:0];
    (* mark_debug = "true"*) logic out_valid_layer9;
    (* mark_debug = "true"*) logic new_line_out_1_layer9;

    // Layer 10 -> Layer 11
    (* mark_debug = "true"*) logic [OUT_WIDTH_LAYER10-1:0] layer_y_out_layer10 [PE_COL_NUM_LAYER10-1:0];
    (* mark_debug = "true"*) logic out_valid_layer10;
    (* mark_debug = "true"*) logic new_line_out_1_layer10;

    // Layer 11 -> Adatper
    (* mark_debug = "true"*) logic [OUT_WIDTH_LAYER11-1:0] layer_y_out_layer11 [PE_COL_NUM_LAYER11-1:0];
    (* mark_debug = "true"*) logic out_valid_layer11;
    (* mark_debug = "true"*) logic new_line_out_1_layer11;
