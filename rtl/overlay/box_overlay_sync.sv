module box_overlay_sync #(
    ...
    (* mark_debug = "true" *) output logic [23:0]        video_rgb_out,
    ...
    (* mark_debug = "true" *) logic       cur_hit ;
    (* mark_debug = "true" *) logic [7:0] cur_conf;
    (* mark_debug = "true" *) logic [7:0] cur_cls ;
    ...
    // =========================================================
    (* mark_debug = "true" *) logic [5:0]  word_cnt; 
