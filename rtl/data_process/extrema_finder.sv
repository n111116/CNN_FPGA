module extrema_finder #(
    ...
    input  logic signed    [DATA_WIDTH-1:0] data_in [PE_COL_NUM-1:0],
    ...
    // =========================================================
    always_comb begin
        cycle_best = data_in[0];
        cycle_best_pe_idx = 0;
        
        for (int i = 1; i < PE_COL_NUM; i++) begin
            if (CONV_POSITIVE) begin
                if (data_in[i] > cycle_best) begin
        ...
        if (!rst_n) begin
            ...
            if(clk_en) begin
                ...
                if (new_line_1) begin
                    ...
                    current_best         <= INIT_VAL;
                    current_best_channel <= 0;
                end else if (data_input_valid) begin
