...
`define LAYER7_VH
    ...
    parameter int unsigned PE_COL_NUM_LAYER7       = 2;  
    parameter int unsigned PE_ROW_NUM_LAYER7       = 9;  
    parameter int unsigned KERNEL_COL_LAYER7       = 3;
    parameter int unsigned KERNEL_ROW_LAYER7       = 3;  
    parameter int unsigned CHANNEL_OUT_NUM_LAYER7  = 32;
    parameter int unsigned CHANNEL_IN_NUM_LAYER7   = 32;  
    parameter int unsigned MAX_POOL_LAYER7         = 0;
    parameter int unsigned WITH_RELU_LAYER7        = 1;
    ...
    parameter int unsigned BIAS_WIDTH_LAYER7       = 18;
    parameter int unsigned OUT_WIDTH_LAYER7        = 8;
    ...
    // 5. 自动计算的中间位宽
    parameter int unsigned PE_PAGE_OUTPUT_WIDTH_LAYER7 = 21;
    parameter int unsigned ACC_WIDTH_LAYER7        = 26;

    /* Simulation Paths */
    localparam INPUT_FILE_PATH_LAYER7       = "C:/Users/24455/Desktop/FPGA/prj/cnn_usb_copy_0323/cnn_usb_copy/conv_data_hex/layer7_input_8bit.hex";
