...
`define LAYER6_VH
    ...
    // 1. 架构参数
    parameter int unsigned PE_PAGE_NUM_LAYER6      = 4;
    ...
    parameter int unsigned CHANNEL_IN_NUM_LAYER6   = 64;  
    ...
    parameter int unsigned BIAS_WIDTH_LAYER6       = 17;
    ...
    parameter int unsigned SHIFT_KEY_LAYER6        = 8;
    ...
    parameter int unsigned ACC_WIDTH_LAYER6        = 27;

    /* Simulation Paths */
    localparam INPUT_FILE_PATH_LAYER6       = "C:/Users/24455/Desktop/FPGA/prj/cnn_usb_copy_0323/cnn_usb_copy/conv_data_hex/layer6_input_8bit.hex";
