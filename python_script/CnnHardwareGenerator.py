...
class CnnHardwareGenerator:
    def __init__(self, layer_num, pe_page_num, pe_col_num,
                 ...
                 bit_width_data = 8,
                 bit_width_out = 8,
                 output_mem_dir="rtl/data_process/mem_data", 
                 output_vh_dir="rtl/data_process/header",
...
`define LAYER{n}_VH
    ...
    /* Simulation Paths */
    localparam INPUT_FILE_PATH_LAYER{n}       = "C:/Users/24455/Desktop/FPGA/prj/cnn_usb_copy_0323/cnn_usb_copy/conv_data_hex/layer{self.layer_num}_input_{self.bit_widths['data']}bit.hex";
