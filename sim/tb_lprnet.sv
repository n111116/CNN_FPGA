...
module tb_lprnet;
    ...
    logic [DATA_WIDTH_LAYER20-1:0] data_input [PE_PAGE_NUM_LAYER20-1:0];

    // ---------------- 层间互联信号 ----------------
    // Layer 20 -> Layer 21
    (* mark_debug = "true" *) logic [OUT_WIDTH_LAYER20-1:0] layer_y_out_layer20 [PE_COL_NUM_LAYER20-1:0];
    (* mark_debug = "true" *) logic out_valid_layer20;
    (* mark_debug = "true" *) logic new_line_out_1_layer20;

    // Layer 21 -> Layer 22
    (* mark_debug = "true" *) logic [OUT_WIDTH_LAYER21-1:0] layer_y_out_layer21 [PE_COL_NUM_LAYER21-1:0];
    (* mark_debug = "true" *) logic out_valid_layer21;
    (* mark_debug = "true" *) logic new_line_out_1_layer21;

    // Layer 22 -> Layer 23
    (* mark_debug = "true" *) logic [OUT_WIDTH_LAYER22-1:0] layer_y_out_layer22 [PE_COL_NUM_LAYER22-1:0];
    (* mark_debug = "true" *) logic out_valid_layer22;
    (* mark_debug = "true" *) logic new_line_out_1_layer22;

    // Layer 23 -> Layer 24
    (* mark_debug = "true" *) logic [OUT_WIDTH_LAYER23-1:0] layer_y_out_layer23 [PE_COL_NUM_LAYER23-1:0];
    (* mark_debug = "true" *) logic out_valid_layer23;
    (* mark_debug = "true" *) logic new_line_out_1_layer23;

    // Layer 24 -> Layer 25
    (* mark_debug = "true" *) logic [OUT_WIDTH_LAYER24-1:0] layer_y_out_layer24 [PE_COL_NUM_LAYER24-1:0];
    (* mark_debug = "true" *) logic out_valid_layer24;
    (* mark_debug = "true" *) logic new_line_out_1_layer24;

    // Layer 25 -> Layer 26
    (* mark_debug = "true" *) logic [OUT_WIDTH_LAYER25-1:0] layer_y_out_layer25 [PE_COL_NUM_LAYER25-1:0];
    (* mark_debug = "true" *) logic out_valid_layer25;
    (* mark_debug = "true" *) logic new_line_out_1_layer25;

    // Layer 26 -> Layer 27
    (* mark_debug = "true" *) logic [OUT_WIDTH_LAYER26-1:0] layer_y_out_layer26 [PE_COL_NUM_LAYER26-1:0];
    (* mark_debug = "true" *) logic out_valid_layer26;
    (* mark_debug = "true" *) logic new_line_out_1_layer26;

    // Layer 27 -> Layer 28
    (* mark_debug = "true" *) logic [OUT_WIDTH_LAYER27-1:0] layer_y_out_layer27 [PE_COL_NUM_LAYER27-1:0];
    (* mark_debug = "true" *) logic out_valid_layer27;
    (* mark_debug = "true" *) logic new_line_out_1_layer27;

    // Layer 28 -> Post Process
    (* mark_debug = "true" *) logic [OUT_WIDTH_LAYER28-1:0] layer_y_out_layer28 [PE_COL_NUM_LAYER28-1:0];
    (* mark_debug = "true" *) logic out_valid_layer28;
    (* mark_debug = "true" *) logic new_line_out_1_layer28;
    
    // 无符号转有符号 (针对 Post Process)
    logic signed [OUT_WIDTH_LAYER28-1:0] layer28_y_out_signed [PE_COL_NUM_LAYER28-1:0];
    assign layer28_y_out_signed = $signed(layer_y_out_layer28);
