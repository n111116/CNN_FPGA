...
`define LAYER27_VH
    ...
    // 1. 架构参数
    parameter int unsigned PE_PAGE_NUM_LAYER27      = 4;
    ...
    parameter int unsigned BIAS_WIDTH_LAYER27       = 17;
    parameter int unsigned OUT_WIDTH_LAYER27        = 9;

    // 3. 周期与映射参数
    parameter int unsigned CYCLE_PERIOD_IN_LAYER27  = 32; 
    ...
    parameter int unsigned SHIFT_KEY_LAYER27        = 9;
