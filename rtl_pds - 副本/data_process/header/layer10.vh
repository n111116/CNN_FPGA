...
`define LAYER10_VH
    ...
    parameter int unsigned PE_COL_NUM_LAYER10       = 1;  
    parameter int unsigned PE_ROW_NUM_LAYER10       = 1;  
    parameter int unsigned KERNEL_COL_LAYER10       = 1;
    parameter int unsigned KERNEL_ROW_LAYER10       = 1;  
    parameter int unsigned CHANNEL_OUT_NUM_LAYER10  = 16;
    parameter int unsigned CHANNEL_IN_NUM_LAYER10   = 32;  
    parameter int unsigned MAX_POOL_LAYER10         = 0;
    parameter int unsigned WITH_RELU_LAYER10        = 0;
    ...
    parameter int unsigned BIAS_WIDTH_LAYER10       = 15;
    parameter int unsigned OUT_WIDTH_LAYER10        = 9;
    ...
    parameter int unsigned SHIFT_KEY_LAYER10        = 9;
    ...
    // 5. 自动计算的中间位宽
    parameter int unsigned PE_PAGE_OUTPUT_WIDTH_LAYER10 = 17;
    parameter int unsigned ACC_WIDTH_LAYER10        = 22;

    /* Simulation Paths */
    localparam INPUT_FILE_PATH_LAYER10       = "C:/Users/Datou21/Desktop/PDS/back1/cnn_usb_copy/conv_data_hex_pds/layer10_input_8bit.hex";
