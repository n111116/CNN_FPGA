...
`define LAYER1_VH
    ...
    // 1. 架构参数
    parameter int unsigned PE_PAGE_NUM_LAYER1      = 1;
    ...
    parameter int unsigned CHANNEL_IN_NUM_LAYER1   = 8;  
    ...
    parameter int unsigned BIAS_WIDTH_LAYER1       = 14;
    ...
    parameter int unsigned SHIFT_KEY_LAYER1        = 6;
    ...
    parameter int unsigned ACC_WIDTH_LAYER1        = 24;

    /* Simulation Paths */
    localparam INPUT_FILE_PATH_LAYER1       = "C:/Users/Datou21/Desktop/PDS/back1/cnn_usb_copy/conv_data_hex_pds/layer1_input_8bit.hex";
