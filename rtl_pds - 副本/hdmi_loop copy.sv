...
module hdmi_loop #(
    ...
    logic [11:0] bram_rd_addr      [0:MAX_BOX_NUM-1]; // BRAM 寻址 (12位，对应4096深)
    ...
    // [全新架构] 视频流打上 YOLO 预选框，并将内容抓取放入 BRAM 池
    ...
    // [全新架构] 轮询 BRAM，利用 2D DDA 随机寻址产生固定大小图片流
    lprnet_ram_upscaler #(
        .MAX_BOX_NUM(MAX_BOX_NUM),
        .LINE_GAP(10_000),  
        .CROP_WIDTH(CROP_WIDTH),
